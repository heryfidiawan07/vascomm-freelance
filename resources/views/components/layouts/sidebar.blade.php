					...
					@canany(['role-menu','user-menu'])
						<li class="sidebar-list">
							<a class="sidebar-link sidebar-title" href="#">
								<i data-feather="settings"></i><span class="lan-6">User & Permission</span>
							</a>
							<ul class="sidebar-submenu">
								@can('role-menu')
									<li><a href="{{ route('role.index') }}"><i data-feather="shield"></i>Role</a></li>
								@endcan
								@can('user-menu')
									<li><a href="{{ route('user.index') }}"><i data-feather="users"></i>User</a></li>
								@endcan
							</ul>
						</li>
					@endcanany
